					        ...
					        <div class="col-lg-12 grid-margin stretch-card">
					            <div class="card">
					                <div class="card-body">
										...
										<%--
											<button type="button" class="btn btn-inverse-info btn-fw" onclick="'">이름</button>
												사용하실때 타입 원하시는거 적고  button이면 onclick 안에 주소 적으시고 submit이면 onclick 부분 지우시면 됩니다.
												이름 부분은 화면에 보여지는 부분입니다.
										 --%>	
					                	</div>
		                			</div>
		              			</div>
