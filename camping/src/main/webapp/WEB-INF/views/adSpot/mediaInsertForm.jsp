					                	...
					                	<div class="table-responsive pt-3">
											<form action="/adSpot/mediaPro" method="post" name="check">
												<table class="table table-dark" >
													...
													<tr>
														<td>
															<button type="button" class="btn btn-inverse-info btn-fw" onclick="searchSpot()">캠핑장찾기</button>
														</td>	
													</tr>
													<tr>
														<td>
													...
													<tr><td><button type="submit" class="btn btn-inverse-success btn-fw">등록</button></td></tr>													
												</table>
											</form>	
				                		</div>
		                			</div>
